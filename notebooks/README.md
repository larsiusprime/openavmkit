...
The four pipeline notebooks are designed to be run in order against a single locality. Each notebook starts from the previous notebook's output via the checkpoint system, so you can stop and resume between stages.
